...
const BottomBar = ({
    ...
    return (
        <Stack
            ...
            width={'100vw'}
        >
            <Link href="https://github.com/serhij-tymoschenko/blumen-js" target="_blank" rel="noopener"
                  justifySelf={"flex-start"}>
                <svg fill={isDarkTheme ? '#FFFFFF' : '#000000'} height="32" aria-hidden="true" viewBox="0 0 24 24" width="32">
                <path
    ...
    <Link href="https://buymeacoffee.com/tymoschenko" target="_blank" rel="noopener"
        ...
        <img src={bmc} width={114} height={32}/>
    </Link>
</Stack>
)
